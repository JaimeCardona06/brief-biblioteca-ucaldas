...
Llena esta tabla con lo que observaste al correr cada prueba en la versión con IA FIAT-proyecto-v2 que es la rama donde se localiza. Pegala en tu `bitacora.md`.
